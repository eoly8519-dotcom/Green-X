-- NEXUS FREE v7.4 â€” SELF-CONTAINED
-- Build: 2026-02-26 14:53:53
-- Build ID: 36ae3bc8057b
-- By: Ryu & Cuakcer â€” #FREEWALTERSANCHEZ
-- ALL-IN-ONE â€” NO LOADSTRING, NO EXTERNAL URLS
-- Generated by builder.py â€” DO NOT EDIT MANUALLY
...
-- ============================================
-- ANTI-HOOK BOOTSTRAP â€” Pre-boot critical function snapshot
-- Captures C-closure references BEFORE any hooks can be installed.
-- All security checks use these snapshots, not live globals.
-- ============================================
local _SAFE = {}
do
    -- Snapshot core functions at load time (unhookable â€” first to execute)
    _SAFE.pcall    = pcall
    _SAFE.type     = type
...
_modules["security"] = function()
    ...
    --[[
        Nexus Security Module v6.6 â€” ANTI-HOOK / ANTI-TAMPER
        ...
        NEXUS FREE â€” #FREEWALTERSANCHEZ
    ]]
    ...
    local function _getCriticalFunctions()
        -- ANTI-HOOK: Direct global references â€” NEVER use getfenv (poisonable)
        local criticals = {}
...
_modules["utils"] = function()
    ...
    -- ============================================
    -- Nexus/
    -- â”œâ”€â”€ Data/           (.nxs key and stats files)
    -- â”œâ”€â”€ Assets/
    -- â”‚   â”œâ”€â”€ Images/     (logo, icons)
    -- â”‚   â””â”€â”€ Sounds/     (bankai.mp3, etc.)
    -- â””â”€â”€ Bin/            (reserved for scripts)
    ...
    function Utils.notifyKill(webhookUrl, targetName, bountyGained, totalStats, extraInfo)
        ...
        local statPrefix = (factionName == "Marine") and "â˜…" or "$"
        ...
        return Utils.sendWebhook(webhookUrl, {
            components = {
                ...
                container({
                    -- Header
                    textDisplay("# âš”ï¸ KILL CONFIRMED"),
                    separator(1, true),
                    ...
                    -- Session stats
                    textDisplay("### ðŸ“Š Session Stats"),
                    section(
                    ...
                    textDisplay(
                        "-# ðŸŒŽ " ..
                        regionName .. " â€¢ âš“ " .. factionName .. " â€¢ â± " .. Utils.formatTime(totalStats.totalPlayTime) ..
                        " â€¢ ðŸ”„ " .. tostring(totalStats.serversHopped) .. " hops\n" ..
                        "-# ðŸ‘¤ " .. lp.Name .. " â€¢ NexusBounty v" .. Utils.CLIENT_VERSION
                    ),
                }, 15158332), -- Red accent
            }
        })
            ...
            components = {
                container({
                    ...
                    textDisplay(
                        ...
                        " gained â€¢ â± " .. Utils.formatTime(stats.totalPlayTime) ..
                        " â€¢ ðŸ‘¤ " .. lp.Name
                    ),
                }, 3447003), -- Blue accent
            }
    ...
    function Utils.notifyAchievement(webhookUrl, achievement, stats)
        return Utils.sendWebhook(webhookUrl, {
            components = {
                container({
                    textDisplay("# ðŸ† ACHIEVEMENT UNLOCKED"),
                    separator(1, true),
    ...
    function Utils.notifyStart(webhookUrl, config)
        ...
        return Utils.sendWebhook(webhookUrl, {
            components = {
                container({
                    textDisplay("# â–¶ï¸ NEXUSBOUNTY STARTED"),
                    separator(1, true),
                    section(
                    ...
                    separator(1, true),
                    textDisplay("-# NexusBounty v" .. Utils.CLIENT_VERSION .. " â€¢ Blox Fruits â€¢ By: Ryu & Cuakcer"),
...
_modules["config"] = function()
    ...
    -- â•‘                    ROBLOX SERVER REGIONS                      â•‘
    -- â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£
    -- â•‘  SOUTH AMERICA                                                â•‘
    -- â•‘   - Brazil                                                    â•‘
    -- â•‘                                                               â•‘
    -- â•‘ ðŸ‡¯ðŸ‡µ ASIA & ASIA-PACIFIC                                        â•‘
    -- â•‘   - Japan (Tokyo)                                             â•‘
    -- â•‘   - Singapore                                                 â•‘
    -- â•‘   - Hong Kong                                                 â•‘
    -- â•‘   - India (Mumbai)                                            â•‘
    -- â•‘                                                               â•‘
    -- â•‘ ðŸ‡¦ðŸ‡º OCEANIA                                                    â•‘
    -- â•‘   - Australia (Sydney)                                        â•‘
    -- â•‘                                                               â•‘
    -- â•‘ ðŸ‡ªðŸ‡º EUROPE                                                     â•‘
    -- â•‘   - UK (London)                                               â•‘
    -- â•‘   - Germany (Frankfurt)                                       â•‘
    -- â•‘   - Netherlands (Amsterdam)                                   â•‘
    -- â•‘   - Poland (Warsaw)                                           â•‘
    -- â•‘                                                               â•‘
    -- â•‘  NORTH AMERICA                                                â•‘
    -- â•‘   - USA (California, Oregon, Virginia, Miami, Texas)          â•‘
    ...
    -- (Forked from NexusPremium â€” no Utils dependency)
    -- ============================================
...
_modules["ui"] = function()
    ...
    -- ============================================================================
    -- CONFIG POPUP (opened via âš™ button)
    -- ============================================================================
    ...
    local function createConfigPopup(screenGui)
        ...
        local titleText = isFirstRun and "âš¡ Welcome to NexusBounty!" or "âš™ Configuration"
        ...
        local function createEnhancedDropdownRow(parent, label, options, currentValue, onChanged, layoutOrder)
            ...
            dropBtn.Text = "  " .. tostring(currentValue) .. "  â–¼"
            ...
            local function showDropdown()
                ...
                for i, option in ipairs(options) do
                    ...
                    optionBtn.MouseButton1Click:Connect(function()
                        -- Update main button
                        dropBtn.Text = "  " .. tostring(option) .. "  â–¼"
        ...
        testWebhookBtn.MouseButton1Click:Connect(function()
            ...
            task.spawn(function()
                local success = Utils.sendWebhook(webhookUrl, {
                    ...
                    description = "Webhook connection successful! ðŸŽ¯",
                    color = 0x5865F2,
                    fields = {
    ...
    local function createDashboard(parent)
        ...
        local statPrefix = (faction == "Marine") and "â˜…" or "$"
        ...
        local keyTimerConnection = RunService.Heartbeat:Connect(function()
            if keyExpiryTotalSeconds <= 0 then
                -- Premium key (no expiry) â€” show infinity
                keyTimerLabel.Text = "âˆž PERMANENT"
        ...
        -- Pick icon based on faction: â‚¿ for Bounty (pirate), âš“ anchor-like for Honor (marine)
        local bountyIcon = (statLabel == "Honor") and "âš“ï¸Ž" or "â‚¿"
        ...
        -- Kill GFX â€” Coming Soon (disabled)
        killGfxBtn.MouseButton1Click:Connect(function()
            killGfxBtn.Text = "Soonâ„¢"
    ...
    function UI.init(utilsModule, configModule, authModule)
        ...
        -- â•â•â• FORCE PC INPUT SCHEME ON MOBILE â•â•â•
        ...
        pcall(function()
            ...
            if UI._isMobile then
                -- â•â• FORCE PC KEYBOARD/MOUSE SCHEME â•â•
                ...
                -- â•â• AUTO-RESIZE TO SMALLEST POSSIBLE FACTOR â•â•
                ...
                -- Aggressively shrink on mobile â€” but enforce a minimum so it doesn't collapse
        ...
        -- â•â•â• PREMIUM SPLASH / LOADING SCREEN â•â•â•
        ...
        local tipsList = {
            "ðŸ’¡ TIP: use Angle v4 + Kit for No SUS KILLS",
            "ðŸ’¡ TIP: Set Region to Auto for fastest hops",
            "ðŸ’¡ TIP: Use /link in Discord to unlock premium",
            "ðŸ’¡ TIP: Press RightControl to toggle UI",
            "ðŸ’¡ TIP: Enable AutoBuso for constant Haki",
        }
        ...
        -- â•â•â• ANIMATE ROTATING DOT RING â•â•â•
        task.spawn(function()
            local rotation = 0
        ...
        -- â•â•â• BACKGROUND GRADIENT SHIFT â•â•â•
        task.spawn(function()
            local rot = 45
            while splashActive and splashFrame.Parent do
                rot = rot + 1
        ...
        -- â•â•â• STAGED LOADING ANIMATION â•â•â•
        local stages = {
        ...
        -- â•â•â• DYNAMIC ISLAND (Glass-style performance pill) â•â•â•
        do
            ...
            -- Top highlight (glass reflection) â€” sits OUTSIDE the island via an overlay so UIListLayout ignores it
            ...
            -- â•â•â• MOBILE QUICK RESIZE BUTTONS â•â•â•
            if isMobile then
                createDivider(6)
            ...
            task.spawn(function()
                ...
                while screenGui and screenGui.Parent do
                    ...
                    -- If send rate > 100 KB/s, warn user â€” high send can trigger server-side security kicks
        ...
        -- â•â•â• MINIMIZE BUTTON (padded pill, right side of drag handle) â•â•â•
        task.defer(function()
        ...
        -- â•â•â• DISCORD BUTTON (padded pill, left of minimize) â•â•â•
        task.defer(function()
        ...
        UI.KeyScreen = createKeyScreen(rightPanel, function()
            -- Auth success â€” check if config needed
    ...
    function UI.updateStats()
        ...
        local prefix = (UI.Elements.statPrefix) or "â‚¿"
    ...
    local NotifTypes = {
        success = { icon = "âœ“", color = Color3.fromRGB(52, 211, 153), accent = Color3.fromRGB(16, 185, 129) },
        warning = { icon = "âš ", color = Color3.fromRGB(251, 191, 36), accent = Color3.fromRGB(245, 158, 11) },
        error   = { icon = "âœ•", color = Color3.fromRGB(239, 68, 68),  accent = Color3.fromRGB(220, 38, 38) },
        info    = { icon = "â„¹", color = Color3.fromRGB(96, 165, 250), accent = Color3.fromRGB(59, 130, 246) },
    }
    ...
    function UI.showIslandNotification(text, notifType, duration)
        ...
        -- â•â•â• ANIMATE OUT (after duration) â•â•â•
    ...
    do
        ...
        local function processQueue()
            ...
            -- Progress indicator â€” thin line at bottom that shrinks
            local progressBar = Instance.new("Frame")
...
_modules["main"] = function()
    ...
    --[[
        NexusBounty Main v6.5 â€” HYPER MODE (Forked from NexusPremium HyperLib v7.2)
        Aggressive hyper-speed combat module
        ONLY Fruit, Faction, Region configurable via GUI
        ALL combat constants/offsets HARDCODED â€” do NOT change
        Developers: Ryu & Cuakcer â€” #FREEWALTERSANCHEZ
    ]]
    ...
    -- ============================================
    -- START â€” Full aggressive combat logic (from HyperLib)
    ...
    function Main.start()
        ...
        task.spawn(function()
            ...
            if not (lp.Character and lp.Character:FindFirstChild("HumanoidRootPart")) then
                print("[NexusBounty] [HYPER] Character not spawned â€” handling team selection")
                ...
                print("[NexusBounty] [HYPER] Character already exists â€” skipping team selection")
            end
    
            print("[NexusBounty] [HYPER] Character ready â€” initializing combat systems")
            ...
            -- ============================================
            -- HARDCODED COMBAT CONSTANTS â€” DO NOT CHANGE
            -- ============================================
            ...
            print("[NexusBounty] [HYPER] All systems initialized â€” starting combat loops")
    
            -- ============================================
            -- CONTINUOUS M1 ATTACK LOOP â€” NEVER STOPS
            -- ============================================
            ...
            -- ============================================
            -- TARGET CYCLE LOOP â€” aggressive 0.4s cycle
            -- ============================================
            ...
            -- ============================================
            -- MAIN UTILITY LOOP (PvP, antimover, v4) â€” keeps thread alive
            -- ============================================
            print("[NexusBounty] [HYPER] Starting PvP/utility loop â€” SCRIPT IS NOW FULLY ACTIVE")
            while wait(1) do
                pcall(function()
                    PvpEnable()
                    antimover()
...
-- ============================================
-- LOADER (self-contained â€” no external deps)
-- ============================================

--[[
    â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—
    â•‘                       NexusBounty                              â•‘
    â•‘              Glassmorphic Bounty Hunting System                â•‘
    â•‘                       Version 5.3                              â•‘
...
-- ============================================
-- MODULE LOADER (Embedded â€” uses _modules registry)
-- ============================================
